...
<%
    ...
    // Database-il irundhu data-vai fetch seiya vendum (Method DAO-vil illaiyenil add seiyavum)
...
<div class="bg-white/10 backdrop-blur-xl p-10 rounded-[40px] border border-white/20 w-full max-w-2xl shadow-2xl">
    ...
    <form action="updateReservation" method="POST" class="space-y-6">
        ...
        <button type="submit" class="w-full bg-blue-600 hover:bg-blue-500 text-white font-black py-5 rounded-2xl transition-all shadow-xl">
            SAVE CHANGES
        </button>
    </form>
</div>
<% } else { %>
<p class="text-white">Reservation not found.</p>
<% } %>
</body>
</html>